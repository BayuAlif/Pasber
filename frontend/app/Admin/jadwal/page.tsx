...
export default function KelolaJadwalPage() {
  ...
  const approved = workOrders.filter(
    w => w.work_order?.statusWO === 'approved'
  ).length;

  const running = workOrders.filter(
    w => w.work_order?.statusWO === 'running'
  ).length;

  const done = workOrders.filter(
    w => w.work_order?.statusWO === 'done'
  ).length;
  ...
  const filtered = workOrders.filter(w => {
    ...
    const matchStatus =
      ...
      filterStatus === 'All Status'
        ? true
        : w.work_order?.statusWO === filterStatus;
              ...
              <table className="w-full">
                ...
                <tbody>
                  ...
                  {paginated.map((w, i) => (
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        ...
                        <p className="text-[12px] font-semibold text-white">
                          {w.kendaraan?.merek} - {w.kendaraan?.model}
                        </p>
                    ...
                    uppercase
                    tracking-wider
                    ${STATUS_STYLE[w.work_order?.statusWO as WOStatus]}
                  `}
                        >
                          {w.work_order?.statusWO}
                        </span>
                      ...
                      <td className="px-5 py-4">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          {/* APPROVED */}
                          {w.work_order?.statusWO === 'approved' && (
              ...
              <div className="bg-[#13161e] border border-[#1e2230] rounded-xl p-5">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-[18px] font-bold text-white">
                        ...
                        {selectedWO.kendaraan?.merek}{" "}
                        {selectedWO.kendaraan?.model}
                      ...
                      <div className="flex gap-2 mt-1">
                        ...
                        <span className="px-2 py-0.5 bg-[#1a1d28] border border-[#2a2f3e] rounded text-[10px] font-mono text-[#9ca3af]">
                          ...
                          {selectedWO.kendaraan?.nomorPolisi}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[13px] font-semibold text-orange-400">
                        ...
                        {selectedWO.work_order?.estimasiWaktu
                          ? `${selectedWO.work_order.estimasiWaktu} Menit`
                          : "-"}
                ...
                <div className="flex items-center gap-3 p-3 bg-[#0f1117] border border-[#1e2230] rounded-xl mt-4">
                  ...
                  <span className="text-[10px] font-bold text-orange-400">
                    ...
                    {selectedWO.work_order?.statusWO}
