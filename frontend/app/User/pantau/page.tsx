        ...
        {filteredWorkOrders.length === 0 ? (
          <div className="py-20 text-center text-[#9ca3af]">
            <p className="text-lg font-semibold text-white mb-2">
              Belum ada{' '}
              <Link href="/User/service" className="text-orange-500 hover:text-orange-400 underline">
                booking
              </Link>.
            </p>
            <p className="text-sm">Coba lagi nanti atau gunakan fitur booking untuk membuat layanan baru.</p>
          </div>
        ) : (
